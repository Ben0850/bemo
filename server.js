...
app.get('/api/rentals', (req, res) => {
  ...
  let sql = `SELECT r.id, r.vehicle_id, fv.license_plate, fv.manufacturer, fv.model, r.customer_name, r.start_date, r.end_date, r.start_time, r.end_time, r.km_start, r.km_end, r.mietart, r.status, r.notes, r.created_at, r.versicherung,
